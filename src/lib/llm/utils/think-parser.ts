/**
 * Incremental streaming parser for <thinking>...</thinking> reasoning tags.
 *
 * Tokens are pushed one-by-one as they arrive from the streamer.
 * The parser tracks whether we are currently inside a <thinking> block
...
export class ThinkStreamParser {
    /** Accumulated reasoning text (inside <thinking>…</thinking>). */
    reasoning = "";
